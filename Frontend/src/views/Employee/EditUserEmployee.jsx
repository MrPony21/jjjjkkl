...
export function EditUserEmployee() {
    ...
    const rolSelect = [{ rol: "empleado" }, { rol: "cliente" }];
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                ...
                const fetchUserName = usersData
                .filter(user => user.user_rol !== "administrador") // Filtrar por user_rol
                .map(user => ({
                    username: user.user_name || "" // Retornar el username
                }));
